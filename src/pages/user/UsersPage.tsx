      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredUsers?.map((user: User) => (
            <Card key={user.email} className="flex flex-col">
              ...
              <CardContent className="flex-grow space-y-2 pb-2">
                ...
                <p className="text-sm">
                  <span className="font-semibold">Phone:</span> {user.email}
                </p>
                <p className="text-sm">
                ...
                <p className="text-sm">
                  <span className="font-semibold">Website:</span> {user.email}
                </p>
              </CardContent>
              <CardFooter>
                <Link to={`/users/${user.email}`} className="w-full">
